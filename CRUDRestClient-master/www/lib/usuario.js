...
$.usuario.HOST = 'http://localhost:3001';
// $.usuario.URL = '/GA-JPA/webresources/com.iesvdc.acceso.entidades.usuario';
$.usuario.URL = '/Gestion_Biblioteca/webresources/entidades.usuario';
...
$.usuario.UsuarioReadREST = function(id) {
    if ( id === undefined ) {
        ...
        $.ajax({
            url: 'http://localhost:3001/Gestion_Biblioteca/webresources/entidades.usuario',
            type: 'GET',
            dataType: 'json',
            success: function (json) {
